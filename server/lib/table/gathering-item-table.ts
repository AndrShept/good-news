...
export const WOODCUTTING_TABLE = {
  FOREST: [
    ...
    { itemKey: 'PINE_LOG',     chance: 20, requiredMinSkill: 0,  maxGatherQuantity: 3 },
...
export const FORAGING_TABLE = {
  FOREST: [
    ...
    { itemKey: 'REDCAP_MUSHROOM',    chance: 25, requiredMinSkill: 0,  maxGatherQuantity: 3 },
    { itemKey: 'ROSE',               chance: 15, requiredMinSkill: 0,  maxGatherQuantity: 2 },
  ...
  MEADOW: [
    { itemKey: 'COTTON',       chance: 30, requiredMinSkill: 0,  maxGatherQuantity: 3 },
    { itemKey: 'FLAX',         chance: 20, requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'SUNFLOWER',    chance: 20, requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'ROSE',         chance: 10, requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'GREENLEAF',    chance: 8,  requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'SWIFTLEAF',    chance: 6,  requiredMinSkill: 20, maxGatherQuantity: 2 },
    { itemKey: 'SUNGRASS',     chance: 4,  requiredMinSkill: 40, maxGatherQuantity: 1 },
    { itemKey: 'FIRE_BLOSSOM', chance: 2,  requiredMinSkill: 70, maxGatherQuantity: 1 },
  ],

  PLAINS: [
    { itemKey: 'COTTON',     chance: 25, requiredMinSkill: 0,  maxGatherQuantity: 3 },
    { itemKey: 'FLAX',       chance: 20, requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'GREENLEAF',  chance: 18, requiredMinSkill: 0,  maxGatherQuantity: 2 },
    { itemKey: 'SWIFTLEAF',  chance: 15, requiredMinSkill: 20, maxGatherQuantity: 2 },
    { itemKey: 'SUNGRASS',   chance: 10, requiredMinSkill: 40, maxGatherQuantity: 1 },
    { itemKey: 'JASMINE',    chance: 7,  requiredMinSkill: 50, maxGatherQuantity: 1 },
    { itemKey: 'BLOOD_HERB', chance: 4,  requiredMinSkill: 75, maxGatherQuantity: 1 },
    { itemKey: 'FROST_LILY', chance: 1,  requiredMinSkill: 90, maxGatherQuantity: 1 },
  ],
