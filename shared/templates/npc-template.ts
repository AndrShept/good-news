...
const createNpc = (id: string, name: string, type: NPCType, image: string, greetings: string[]): NPC => ({
  id,
  name,
  image,
  type,
...
export const npcTemplate = [
  createNpc('019d78f1-609a-7d97-af2b-9155d9359256', 'Vex Mournshade ', 'ALCHEMIST', imageConfig.npc.vex, [
  ...
  createNpc('019d78f2-d3de-7f28-9cbb-6b3948dac739', 'Aldric Ironforge', 'BLACKSMITH', imageConfig.npc.aldric, [
  ...
  createNpc('019d78f2-eaa4-712e-b3a1-440b4b1c24b4', 'Maria Salthorn', 'COOK', imageConfig.npc.maria, [
  ...
  createNpc('019d78f2-ff60-7e3a-a005-776cacc6a47f', 'Lyra Inkwell', 'INSCRIBER', imageConfig.npc.lyra, [
  ...
  createNpc('019d78f3-17a4-7b42-a1cf-cabf8b8601fa', 'Brom Splintwood', 'TINKER', imageConfig.npc.brom, [
  ...
  createNpc('019d9038-a421-77a1-884c-34a3b7f29cb9', 'Deus Freemore', 'GM_TRADER', imageConfig.npc.deus, [
    'Careful near the shelf — that vial is older than the town itself. Now, what do you need?',
  ]),
